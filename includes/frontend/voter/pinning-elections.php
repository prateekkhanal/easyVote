...
/* $eid = 'D!DCasxCE'; */
$sql = "SELECT COUNT(*) AS pinned from pinned_elections where vid=".$_SESSION['vid']." and eid = '$eid';";
$pinnedCount = mysqli_query($conn, $sql);
if ($pinnedCount->fetch_assoc()['pinned'] != '0') {$pinned = true;}
/* echo $pinnedCount->fetch_assoc()['pinned']; */
if ($pinned == true) {
